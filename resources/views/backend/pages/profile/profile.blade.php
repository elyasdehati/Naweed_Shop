                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group mb-3 row">
                                                                ...
                                                                <div class="col-lg-12 col-xl-12">
                                                                    <input class="form-control" type="file" name="photo" value="{{ $profileData->phone }}" id="image">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group mb-3 row">
                                                                ...
                                                                <div class="col-lg-12 col-xl-12">
                                                                <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/profile/'.$profileData->photo) : url('upload/no_image.png')}}" class="rounded-circle avatar-xl img-thumbnail float-start" alt="image profile">
                                                                </div>
                                                            </div>
