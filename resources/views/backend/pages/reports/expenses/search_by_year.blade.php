    ...
    <div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">گزارش مصارفات سال {{ $year }}</h4>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="badge bg-info">{{ $item->total_expenses }}</span>
                                    </td>
                        ...
                        <div class="d-flex justify-content-start" dir="rtl">
                            <div class="p-4 shadow-sm rounded text-end" 
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="fw-bold text-primary mb-0">{{ number_format($yearlyTotal,2) }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
