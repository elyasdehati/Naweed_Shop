                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    <div class="mb-4 p-0">
                                        <a href="/" class="auth-logo">
                                            <img src="{{ asset('upload/logo/2.jpeg') }}" alt="Naweed Online Shop" class="mx-auto" height="45" />
                                            <span class="text-dark" style="font-weight: bold; font-size: 20px">Nadiry Group</span>
                                        </a>
                                    </div>
                    ...
                    <div class="col-xl-7">
                        <div class="account-page-bg p-md-5 p-4">
                            <div class="text-center">
                                <h3 class="text-dark mb-3 pera-title">پنل مدیریت فروشگاه آنلاین <br> Nadiry Online Shop</h3>
